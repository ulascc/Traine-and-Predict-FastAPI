...
class PredictionStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetPrediction = channel.unary_unary(
                '/predict.Prediction/GetPrediction',
...
def add_PredictionServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'predict.Prediction', rpc_method_handlers)
...
class Prediction(object):
    ...
    def GetPrediction(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/predict.Prediction/GetPrediction',
